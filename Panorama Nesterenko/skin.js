...
function pano2vrSkin(player,base) {
		...
		me._image_1.logicBlock_size = function() {
			...
			if (me._image_1.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._image_1.ggCurrentLogicStateSize == 0) {
					me._image_1.style.width='300px';
					me._image_1.style.height='121px';
					skin.updateSize(me._image_1);
				}
				else {
					me._image_1.style.width='420px';
					me._image_1.style.height='147px';
					skin.updateSize(me._image_1);
				}
			}
		}
	...
	player.addListener('configloaded', function(args) { me._rectangle_3.logicBlock_visible();me._controller.logicBlock_visible();me._image_1.logicBlock_size(); });
	me.skinTimerEvent();
};